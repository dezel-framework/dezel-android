...
jmethodID DisplayNodeResolveMarginsMethod;
jmethodID DisplayNodeResolveBordersMethod;
...
JNIDisplayModule(JNIEnv* env)
{
	...
	DisplayNodeResolveMarginsMethod = JNIGetMethod(
		env,
		DisplayNodeClass,
		"onResolveMargins",
		"()V"
	...
	DisplayNodeResolveBordersMethod = JNIGetMethod(
		env,
		DisplayNodeClass,
		"onResolveBorders",
		"()V"
