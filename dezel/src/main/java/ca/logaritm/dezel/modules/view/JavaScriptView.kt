...
open class JavaScriptView(context: JavaScriptContext) : JavaScriptClass(context), DisplayNodeListener, ScrollableListener, SynchronizerCallback {
	...
	/**
	 * The view's resolved left position.
	...
	/**
	 * The view's resolved top border width.
	...
	/**
	 * The view's resolved left border width.
	...
	/**
	 * The view's resolved right border width.
	...
	/**
	 * The view's resolved bottom border width.
	...
	/**
	 * The view's resolved top padding.
	...
	/**
	 * The view's resolved left padding.
	...
	/**
	 * The view's resolved right padding.
	...
	/**
	 * The view's resolved bottom padding.
	...
	/**
	 * The view's resolved x translation.
	...
	/**
	 * The view's resolved y translation.
	...
	/**
	 * The view's resolved z translation.
	...
	/**
	 * The view's resolved x rotation.
	...
	/**
	 * The view's resolved y rotation.
	...
	/**
	 * The view's resolved z rotation.
	...
	open fun createWrapperView(): WrapperView {
		return WrapperView(this.context.activity, this.content)
	}
	...
	/**
	 * Inserts a child view into the view.
	 * @method insert
	 * @since 0.1.0
	 */
	...
	/**
	 * Inserts the view into another view.
	 * @method inject
	 * @since 0.1.0
	 */
	...
	/**
	 * Resolves the size, position and styles of the view.
	 * @method resolve
	 * @since 0.1.0
	 */
	open fun resolve() {
	...
	/**
	 * Updates the view's visual properties.
	 * @method update
	 * @since 0.1.0
	 */
	open fun update() {
	 ...
	 * @since 0.1.0
	 */
	override fun onResolveMargins(node: DisplayNode) {
	...
	override fun onResolveBorders(node: DisplayNode) {
		...
		if (this.resolvedBorderLeftWidth != this.node.measuredBorderLeft) {
			...
			this.measuredBorderLeftWidth.reset(lock = this)
			this.invalidateBorder()
		}
		...
		if (this.resolvedBorderRightWidth != this.node.measuredBorderRight) {
			...
			this.measuredBorderRightWidth.reset(lock = this)
			this.invalidateBorder()
		}
		...
		if (this.resolvedBorderBottomWidth != this.node.measuredBorderBottom) {
			...
			this.measuredBorderBottomWidth.reset(lock = this)
			this.invalidateBorder()
		}
	}
	 ...
	 * @hidden
	 */
	open val backgroundImage by lazy {
		JavaScriptProperty() { value ->
	 ...
	 * @hidden
	 */
	open val backgroundImageFit by lazy {
	 ...
	 * @hidden
	 */
	open val backgroundImagePosition by lazy {
	 ...
	 * @hidden
	 */
	open val borderTopColor by lazy {
		JavaScriptProperty("#000") { value ->
	 ...
	 * @hidden
	 */
	open val borderLeftColor by lazy {
		JavaScriptProperty("#000") { value ->
	 ...
	 * @hidden
	 */
	open val borderRightColor by lazy {
		JavaScriptProperty("#000") { value ->
	 ...
	 * @hidden
	 */
	open val borderBottomColor by lazy {
		JavaScriptProperty("#000") { value ->
	 ...
	 * @hidden
	 */
	open val borderTopWidth by lazy {
		JavaScriptProperty(0.0) { value ->
	 ...
	 * @hidden
	 */
	open val borderLeftWidth by lazy {
		JavaScriptProperty(0.0) { value ->
	 ...
	 * @hidden
	 */
	open val borderRightWidth by lazy {
		JavaScriptProperty(0.0) { value ->
	 ...
	 * @hidden
	 */
	open val borderBottomWidth by lazy {
		JavaScriptProperty(0.0) { value ->
	 ...
	 * @hidden
	 */
	open val minBorderTopWidth by lazy {
	 ...
	 * @hidden
	 */
	open val maxBorderTopWidth by lazy {
	 ...
	 * @hidden
	 */
	open val minBorderLeftWidth by lazy {
		JavaScriptProperty(0.0) {
			this.invalidateBorder()
		}
	}
	 ...
	 * @hidden
	 */
	open val maxBorderLeftWidth by lazy {
		JavaScriptProperty(Double.max) {
			this.invalidateBorder()
		}
	}
	 ...
	 * @hidden
	 */
	open val minBorderRightWidth by lazy {
		JavaScriptProperty(0.0) {
			this.invalidateBorder()
		}
	}
	 ...
	 * @hidden
	 */
	open val maxBorderRightWidth by lazy {
		JavaScriptProperty(Double.max) {
			this.invalidateBorder()
		}
	}
	 ...
	 * @hidden
	 */
	open val minBorderBottomWidth by lazy {
		JavaScriptProperty(0.0) {
			this.invalidateBorder()
		}
	}
	 ...
	 * @hidden
	 */
	open val maxBorderBottomWidth by lazy {
		JavaScriptProperty(Double.max) {
			this.invalidateBorder()
		}
	}
	 ...
	 * @hidden
	 */
	open val shadowOffsetTop by lazy {
		JavaScriptProperty(0.0) {
			this.invalidateShadow()
		}
	}
	 ...
	 * @hidden
	 */
	open val shadowOffsetLeft by lazy {
		JavaScriptProperty(0.0) {
			this.invalidateShadow()
		}
	}
		...
		JavaScriptProperty("auto") { value ->
			...
			when (composite.values.size) {
				...
				4 -> {
					t = composite.values[0]
					l = composite.values[1]
					r = composite.values[3]
					b = composite.values[2]
				}
	 ...
	 * @hidden
	 */
	open val contentHeight by lazy {
		JavaScriptProperty("auto") { value ->
	 ...
	 * @hidden
	 */
	open val contentInsetTop by lazy {
		JavaScriptProperty(0.0) { value ->
	 ...
	 * @hidden
	 */
	open val contentInsetLeft by lazy {
		JavaScriptProperty(0.0) { value ->
	 ...
	 * @hidden
	 */
	open val contentInsetRight by lazy {
		JavaScriptProperty(0.0) { value ->
	 ...
	 * @hidden
	 */
	open val contentInsetBottom by lazy {
		JavaScriptProperty(0.0) { value ->
	 ...
	 * @hidden
	 */
	open val contentDirection by lazy {
	 ...
	 * @hidden
	 */
	open val contentAlignment by lazy {
	 ...
	 * @hidden
	 */
	open val contentDisposition by lazy {
		JavaScriptProperty("start") { value ->
	 ...
	 * @hidden
	 */
	open val minMarginLeft by lazy {
		JavaScriptProperty(Double.min) { value ->
	 ...
	 * @hidden
	 */
	open val maxMarginLeft by lazy {
		JavaScriptProperty(Double.max) { value ->
	 ...
	 * @hidden
	 */
	open val minMarginRight by lazy {
		JavaScriptProperty(Double.min) { value ->
	 ...
	 * @hidden
	 */
	open val maxMarginRight by lazy {
		JavaScriptProperty(Double.max) { value ->
	 ...
	 * @hidden
	 */
	open val minMarginBottom by lazy {
		JavaScriptProperty(Double.min) { value ->
	 ...
	 * @hidden
	 */
	open val maxMarginBottom by lazy {
		JavaScriptProperty(Double.max) { value ->
	 ...
	 * @hidden
	 */
	open val paddingBottom by lazy {
		JavaScriptProperty(0.0) { value ->
	 ...
	 * @hidden
	 */
	open val minPaddingTop by lazy {
		JavaScriptProperty(0.0) { value ->
	 ...
	 * @hidden
	 */
	open val maxPaddingTop by lazy {
		JavaScriptProperty(Double.max) { value ->
	 ...
	 * @hidden
	 */
	open val minPaddingLeft by lazy {
		JavaScriptProperty(0.0) { value ->
	 ...
	 * @hidden
	 */
	open val maxPaddingLeft by lazy {
		JavaScriptProperty(Double.max) { value ->
	 ...
	 * @hidden
	 */
	open val minPaddingRight by lazy {
		JavaScriptProperty(0.0) { value ->
	 ...
	 * @hidden
	 */
	open val maxPaddingRight by lazy {
		JavaScriptProperty(Double.max) { value ->
	 ...
	 * @hidden
	 */
	open val minPaddingBottom by lazy {
		JavaScriptProperty(0.0) { value ->
	 ...
	 * @hidden
	 */
	open val maxPaddingBottom by lazy {
		JavaScriptProperty(Double.max) { value ->
	 ...
	 * @hidden
	 */
	open val scrollInertia by lazy {
	 ...
	 * @hidden
	 */
	open val touchOffsetTop by lazy {
		JavaScriptProperty(0.0)
	}
	 ...
	 * @hidden
	 */
	open val touchOffsetLeft by lazy {
		JavaScriptProperty(0.0)
	}
	 ...
	 * @hidden
	 */
	open val touchOffsetRight by lazy {
		JavaScriptProperty(0.0)
	}
	 ...
	 * @hidden
	 */
	open val touchOffsetBottom by lazy {
		JavaScriptProperty(0.0)
	}
	 ...
	 * @hidden
	 */
	open val measuredWidth by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredHeight by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredInnerWidth by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredInnerHeight by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredContentWidth by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredContentHeight by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredMarginTop by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredMarginLeft by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredMarginRight by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredMarginBottom by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredBorderTopWidth by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredBorderLeftWidth by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredBorderRightWidth by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredBorderBottomWidth by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredPaddingTop by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredPaddingLeft by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredPaddingRight by lazy {
		JavaScriptProperty(lock = this)
	}
	 ...
	 * @hidden
	 */
	open val measuredPaddingBottom by lazy {
		JavaScriptProperty(lock = this)
	}
...
//		}
	...
	open fun jsFunction_insert(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 2) {
			throw Exception("Method JavaScriptView.insert() requires 2 arguments.")
		}
	...
	open fun jsFunction_remove(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 1) {
			throw Exception("Method JavaScriptView.remove() requires 1 argument.")
		}
	...
	open fun jsFunction_appendStyle(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 1) {
			throw Exception("Method JavaScriptView.appendStyle() requires 1 argument.")
		}
	...
	open fun jsFunction_removeStyle(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 1) {
			throw Exception("Method JavaScriptView.removeStyle() requires 1 argument.")
		}
	...
	open fun jsFunction_hasStyle(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 1) {
			throw Exception("Method JavaScriptView.hasStyle() requires 1 argument.")
		}

		callback.returns(this.node.hasStyle(callback.argument(0).string))
	}
	...
	open fun jsFunction_appendState(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 1) {
			throw Exception("Method JavaScriptView.appendState() requires 1 argument.")
		}
	...
	open fun jsFunction_removeState(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 1) {
			throw Exception("Method JavaScriptView.removeState() requires 1 argument.")
		}
	...
	open fun jsFunction_hasState(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 1) {
			throw Exception("Method JavaScriptView.hasState() requires 1 argument.")
		}

		callback.returns(this.node.hasState(callback.argument(0).string))
	}
	...
	open fun jsFunction_scrollTo(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 2) {
			throw Exception("Method JavaScriptView.scrollTo() requires 2 arguments.")
		}
