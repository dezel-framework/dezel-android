...
//		}
	...
	open fun jsFunction_rect(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 4) {
			throw Exception("Method JavaScriptCanvas.rect' requires 4 arguments.")
		}
	...
	open fun jsFunction_fillRect(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 4) {
			throw Exception("Method JavaScriptCanvas.fillRect() requires 4 arguments.")
		}
	...
	open fun jsFunction_strokeRect(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 4) {
			throw Exception("Method JavaScriptCanvas.strokeRect() requires 4 arguments.")
		}
	...
	open fun jsFunction_clearRect(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 4) {
			throw Exception("Method JavaScriptCanvas.clearRect() requires 4 arguments.")
		}
	...
	open fun jsFunction_moveTo(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 2) {
			throw Exception("Method JavaScriptCanvas.moveTo() requires 2 arguments.")
		}
	...
	open fun jsFunction_lineTo(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 2) {
			throw Exception("Method JavaScriptCanvas.lineTo() requires 2 arguments.")
		}
	...
	open fun jsFunction_quadraticCurveTo(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 4) {
			throw Exception("Method JavaScriptCanvas.quadraticCurveTo() requires 4 arguments.")
		}
	...
	open fun jsFunction_bezierCurveTo(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 4) {
			throw Exception("Method JavaScriptCanvas.bezierCurveTo() requires 6 arguments.")
		}
	...
	open fun jsFunction_arc(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 6) {
			throw Exception("Method JavaScriptCanvas.arc() requires 6 arguments.")
		}
	...
	open fun jsFunction_arcTo(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 6) {
			throw Exception("Method JavaScriptCanvas.arcTo() requires 6 arguments.")
		}
	...
	open fun jsFunction_isPointInPath(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 2) {
			throw Exception("Method JavaScriptCanvas.isPointInPath() requires 2 arguments.")
		}
	...
	open fun jsFunction_scale(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 2) {
			throw Exception("Method JavaScriptCanvas.scale() requires 2 arguments.")
		}
	...
	open fun jsFunction_rotate(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 1) {
			throw Exception("Method JavaScriptCanvas.rotate() requires 1 argument.")
		}
	...
	open fun jsFunction_translate(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 2) {
			throw Exception("Method JavaScriptCanvas.translate() requires 2 arguments.")
		}
	...
	open fun jsFunction_transform(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 6) {
			throw Exception("Method JavaScriptCanvas.translate() requires 6 arguments.")
		}
	...
	open fun jsFunction_setTransform(callback: JavaScriptFunctionCallback) {
		...
		if (callback.arguments < 6) {
			throw Exception("Method JavaScriptCanvas.setTransform() requires 6 arguments.")
		}
