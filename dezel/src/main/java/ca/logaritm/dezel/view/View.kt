...
open class View(context: Context) : ViewGroup(context), Scrollable, Resizable, Updatable, Animatable, TouchCancelable, ScaleGestureDetector.OnScaleGestureListener {
	...
	/**
	 * The view's page index on the x axis.
	 * @property pageX
	 * @since 0.1.0
	 */
	open val pageX: Int
	...
	/**
	 * The view'S page index on the y axis.
	 * @property pageY
	 * @since 0.1.0
	 */
	open val pageY: Int
	...
	/**
	 * The amount of pages on the x axis.
	 * @property pageXCount
	 * @since 0.1.0
	 */
	...
	/**
	 * Teh amount of pages on the y axis.
	 * @property pageYCount
	 * @since 0.1.0
	 */
	...
	/**
	 * Dispatches a touch cancel event.
