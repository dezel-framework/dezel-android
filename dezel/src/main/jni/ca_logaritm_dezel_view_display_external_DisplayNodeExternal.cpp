 ...
 * Signature: (J)V
 */
void Java_ca_logaritm_dezel_view_display_external_DisplayNodeExternal_resolveTraits(JNIEnv* env, jclass, jlong displayNodePtr) {
	DisplayNodeResolveTraits(reinterpret_cast<DisplayNodeRef>(displayNodePtr));
}
 ...
 * Signature: (J)V
 */
void Java_ca_logaritm_dezel_view_display_external_DisplayNodeExternal_resolveLayout(JNIEnv* env, jclass, jlong displayNodePtr) {
	DisplayNodeResolveLayout(reinterpret_cast<DisplayNodeRef>(displayNodePtr));
}
